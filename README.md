# 👋 Hey there,
<p>I am a Data Scientist and Engineer with over 10 years of experience designing and optimizing data systems. Proficient in Python, R, SQL, and cloud platforms like AWS, Snowflake, and Redshift, I specialize in ETL pipelines, data migration, and analytics. I have processed over 10M records daily and migrated 500TB of data with 100% accuracy, enhancing scalability by 40% and cutting processing times by 30%. Passionate about delivering actionable insights, I’ve developed dashboards tracking 50+ KPIs, improving forecast accuracy by 20% and driving a 25% year-over-year growth</p>
